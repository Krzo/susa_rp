...
addEventHandler("onClientHouseSystemInfoMenueOpen", gMe, function(owner, x, y, z, price, locked, rentable, rentalprice, id, doingrent, isrentedin, canadd)
	...
	if(getElementData(localPlayer,"username") ~= owner) then
	...
	if(owner ~= "no-one") then
		...
		if(owner == getElementData(localPlayer,"username")) then
...
addEventHandler("onClientHouseSystemGUIStart", gMe, function()
	...
	Fenster[1] = guiCreateWindow(X, Y, Width, Height, "House System",false)
	...
	Bild[1] = guiCreateStaticImage(486,51,290,204,"susa_house/data/images/choose.jpg",false,Fenster[1])
	...
	addEventHandler("onClientGUIClick", Grid[1], function()
		...
		if(text == "") or (text == " ") then
			guiStaticImageLoadImage(Bild[1], "susa_house/data/images/choose.jpg")
		else
			if(fileExists("susa_house/data/images/"..text..".jpg")) then
				guiStaticImageLoadImage(Bild[1], "susa_house/data/images/"..text..".jpg")
			else
				guiStaticImageLoadImage(Bild[1], "susa_house/data/images/choose.jpg")
			end
		end
